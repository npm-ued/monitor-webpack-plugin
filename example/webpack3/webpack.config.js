...
const MonitorPlugin = require('../../index.js'); 
...
module.exports = {
  ...
  plugins: [
    ...
    new MonitorPlugin({
      enable: true,
      inject:'head',
      paths:['http://monitor.91jinrong.com/monitor.js'],
      content:'var config = { appid: \'xcx-admin\',url: \'http://fdmonitor.91jinrong.com/tr.gif\'};new Monitor(config);'
    })
  ],
